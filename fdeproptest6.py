...
class FDEFractalNoPropNetwork(nn.Module):
    ...
    def fde_optimization_step(self, population, target_curve, lr=0.1, tau=0.1):
            ...
            for individual in population:
                ...
                logits = self.simulate_curve(alpha_candidate, W_embed_candidate, params)
                print(logits.shape)
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        #train_fde_model(model, dataloader, vocab_size, device, population_size=5, steps=20, tau=0.0025)
